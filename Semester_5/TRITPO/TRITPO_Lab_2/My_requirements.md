...
Приложение работает на движке VASSAL Engine, преднозначенном для адаптации карточных и настольных игр. Движок содержит массу различных модулей.
...
Люди мужского пола младшей и средней возрастной категории, обладающие средними навыками пользователя пк и увлекающиеся тематикой.
...
2. Функциональые элементы не перегружают экран;
...
### 3.2.3 Ограничения
1. Приложение реализовано на Java и движке VASSAL Engine;
